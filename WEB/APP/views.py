...
def index(request):
    return HttpResponse("<h1>BlackCode URL</h1>"
                        ...
                        + "<br><br><br>"
                        + "<h1>Theme</h1>"
                        + "<a href='http://127.0.0.1:8000/theme/admin/index/x'>Local Theme Admin</a><br>"
                        + "<a href='http://127.0.0.1:8000/theme/game/index/x'>Local Theme Game</a><br>"
                        + "<a href='http://127.0.0.1:8000/theme/industrious/index/x'>Local Theme Industrious</a><br>"
                        + "<br><br><br>"
                        + "<h1>APP</h1>"
